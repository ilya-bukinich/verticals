...
- валидация полей (~~не больше 3 ссылок на фото~~ **+загрузка фото c валидацией размера**, описание не больше 1000 символов, название не больше 200 символов)
...
- обязательные поля в ответе: **+все**, т.к. все формы API на дженериках (лень переделывать)✔~~название объявления, цена, ссылка на главное фото~~
- ~~опциональные поля (можно запросить, передав параметр fields): описание, ссылки на все фото~~

### Метод создания объявления:
- принимает все ~~вышеперечисленные~~ поля **c валидацией**✔ ~~название, описание, несколько ссылок на фотографии (сами фото загружать никуда не требуется)~~ 
